...
AML plugin that adds CLEO opcodes that works as CLEOPlus Render Object opcodes!

## Credits 
- TecoReacvite (Plugin creator)
- Cheeseburger (Opcodes documention)

## [Visual Object documentation 📜](<https://docs.google.com/document/d/1bE5Vq2hb4EIHE7bmFDZsCSxBfJrubZoy4rd_ADBsdVk/edit?usp=sharing>)
```ini
